...
void Renderer::LoadTexture(const std::string &id, const std::string &path) {
	// Habría que comprobar si existe para no crearlo de nuevo
...
// Se inicializa la variable a nullptr
// Todas las variables de una clase estática deben inicializarse al principio
